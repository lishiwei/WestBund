...
import com.lishiwei.westbund.Activity.TelnetDetailActivity;
 ...
 */
public class TalentRecyclerAdapter extends RecyclerView.Adapter<TalentRecyclerAdapter.ViewHolder> {
...
//                    context.startActivity(intent);
                Intent intent = new Intent(context, TelnetDetailActivity.class);
                intent.putExtra("gallery",galleryList.get(holder.getLayoutPosition()));
                context.startActivity(intent);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvGalleryLocation.setText(galleryList.get(position).getCity());
    }
    ...
    public TalentRecyclerAdapter(List<Gallery> galleryList, Context context) {
        this.galleryList = galleryList;
        this.context = context;
    }

    public TalentRecyclerAdapter(Context context) {
