...
import com.lishiwei.westbund.Fragment.FragmentGalleryPkg.FragmentTalent;
...
public class FragmentGalleries extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(FragmentTalent.newInstance("1", ""));
        fragmentList.add(FragmentArtSpot.newInstance("", ""));
        titleString.add(getContext().getResources().getString(R.string.gallery));
        titleString.add(getContext().getResources().getString(R.string.talent));
        titleString.add(getContext().getResources().getString(R.string.xiangChang));
